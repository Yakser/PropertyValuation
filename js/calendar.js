...
function drawCalendarMonthTable(data, option) {
  ...
  container.setAttribute("class", "month-container");
  ...
  document.body.onclick = function (e) {
    ...
    if (
      (targetDomObject &&
        ...
        targetDomObject.classList.contains("prev-next-btn")) ||
      targetDomObject.classList.contains("prev-next-btn-ico")
    ) {
    ...
    if (
      targetDomObject &&
      targetDomObject.classList &&
      targetDomObject.classList.contains("span-month-year")
    ) {
      option = JSON.parse(
        targetDomObject.parentElement.getAttribute("data-option")
      );
